...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype648</identifier>
      <description>Cooja Mote Type bcast</description>
    ...
    <motetype>
      ...
      <description>Sky Mote Type sink2</description>
    ...
    <mote>
      <interface_config>
        ...
        <x>46.63425814256501</x>
        <y>85.67753769754908</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype648</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>78.68195582730044</x>
        <y>50.488586938414436</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>52.08706482690184</x>
        <y>60.62683217778379</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>71.50965633793265</x>
        <y>70.29714144936895</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.88706903804043 0.0 0.0 5.88706903804043 -174.87260161322226 -174.1168521620557</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
