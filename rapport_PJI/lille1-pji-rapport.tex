...
\acro{2XS}{\emph{e\textbf{X}tra \textbf{S}mall e\textbf{X}tra \textbf{S}afe}}
...
\include{02-premier-chapitre}
\include{03-deuxieme-chapitre}
\include{04-troisieme-chapitre}
\include{05-conclusion}

\appendix
% Ici on a pas "vraiment" de biblio
...
%{\textbf{Résumé ---}}
%Résumé, utile ? Je pense pas
%
%{\textbf{Mots clés :}}
%Idem, me semble pas utile
%\\
%\noindent\rule[2pt]{\textwidth}{0.5pt}
%\begin{center}
%  Théo Plockyn \\
